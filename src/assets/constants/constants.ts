...
export const workExperience = [
    ...
    },
    {
        ...
        techStack: ['Golang', 'REST API', 'gRPC', 'MySQL', 'PostgreSQL', 'JavaScript', 'jQuery', 'Jenkins']
    }
]
...
export const myProjects = [
    {
        ...
        description: 'Anonymous platform connecting people to practice English via peer to peer voice calls.',
        techStack: ['React', 'JavaScript', 'NextJS', 'PeerJS', 'Bulma', 'REST API', 'Python', 'Django', 'SQLite']
    },
    {
        projectImage: goosenet,
        projectName: 'GooseNet',
        projectWebsite: 'https://devpost.com/software/goosenet-an-anonymous-community-for-your-apartment',
        githubLink: 'https://github.com/hack-the-loo-2019',
        projectDate: 'September 2019',
        description: 'Anonymous social network for your apartment to talk with each other, ask for help, and borrow stuffs. Submitted to Hack The North 2019',
        techStack: ['React', 'REST API', 'JavaScript', 'NextJS', 'Node', 'Express', 'Firebase']
    },
    {
        ...
        description: 'Won Best Internet of Things award at StarterHacks 2019, a virtual queuing system where people can line up for a service without having to be physically present.',
    ...
    },
    {
        ...
        description: 'Unified access system to replace all physical cards into a single app. Submitted to MakeHarvard 2020.',
        techStack: ['Golang', 'REST API', 'MySQL', 'Google Cloud', 'TypeScript', 'React']
    },
    {
        ...
        description: 'Imitation of Tetris with multiplayer functionality and special actions.',
        techStack: ['C++']
    },
    {
